    ...
    projects: {
      ...
      stakeholderIntelligence: {
        ...
        details: {
          ...
          approach: 'Bewusste Leitplanke von Anfang an: Das Tool bewertet nicht die andere Person, sondern hält strukturiert fest, wie ich selbst kommunizieren möchte. Technisch orientiert an der lokal-first-Architektur des Schwester-Projekts Career Intelligence, aber mit eigenem Next.js/TypeScript-Stack für die interaktive Board-Oberfläche umgesetzt. Als Nächstes geplant: ein lokal laufendes LLM für Farben-Modell-Typisierung (Rot/Gelb/Grün/Blau: dominant, initiativ, stetig, gewissenhaft) und daraus abgeleitete Vorschläge für den Stakeholder-Umgang – weiterhin ohne Cloud-LLM –, eine Anbindung an Kommunikations- und Kalender-Tools (Mail, Slack, Teams, Kalender) für mehr Kontext sowie Reminder-Funktionen für offene Follow-ups.',
    ...
    projects: {
      ...
      stakeholderIntelligence: {
        ...
        details: {
          ...
          approach: 'A deliberate guardrail from the start: the tool does not evaluate the other person, it structures how I want to communicate myself. Technically modelled on the local-first architecture of the sister project Career Intelligence, but implemented with its own Next.js/TypeScript stack for the interactive board interface. Next planned: a locally run LLM for colour-based typing (red/yellow/green/blue: dominant, initiating, steady, conscientious) and derived suggestions for how to engage with the stakeholder—still no cloud LLM—, integration with communication and calendar tools (mail, Slack, Teams, calendar) for more context, plus reminder functions for open follow-ups.',
