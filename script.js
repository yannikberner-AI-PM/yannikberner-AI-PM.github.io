const translations = {
  de: {
    ...
    hero: {
      ...
      intro: 'Energy Product Manager mit mehr als acht Jahren Erfahrung in der Entwicklung und Skalierung komplexer Energie-, IoT- und Datenprodukte. Ich übersetze technische, regulatorische und kommerzielle Anforderungen in Produktstrategien, Roadmaps, Datenmodelle, Steuerungslogiken und marktfähige Piloten.',
      ctaPrimary: 'Berufserfahrung ansehen',
  ...
  en: {
    ...
    hero: {
      ...
      nameSecond: 'BERNER',
      title: 'Energy Product Manager',
      intro: 'Energy Product Manager with more than eight years of experience developing and scaling complex energy, IoT and data products. I translate technical, regulatory and commercial requirements into product strategies, roadmaps, data models, control logic and market-ready pilots.',
      ctaPrimary: 'Explore my experience',
